...
// Display: SPI1 (SCK - PA5, CIPO - PA6, COPI - PA7), CS - PA4, DC - PA3, RS: PA2
...
// Rotary encoder: CLK - PC14, DT - PC15)
pub type EncoderClk = Pin<'C', 14, Input<Floating>>;
pub type EncoderDt = Pin<'C', 15, Input<Floating>>;
